...
<div class="wrap synaplan-settings">
    ...
    <form method="post" action="">
            ...
            <table class="form-table">
                    ...
                    <td>
                        <select name="integration_type" id="integration_type" class="regular-text">
                            ...
                            <option value="inline-box" <?php selected($widget_config['integration_type'] ?? 'floating-button', 'inline-box'); ?>>
                                <?php _e('Inline Box', 'synaplan-wp-ai'); ?>
                            </option>
                        </select>
                        <p class="description"><?php _e('Choose how the widget appears on your site', 'synaplan-wp-ai'); ?></p>
                    </td>
                </tr>
                
                <tr>
                    <th scope="row">
                        <label for="color"><?php _e('Primary Color', 'synaplan-wp-ai'); ?></label>
                    </th>
                    <td>
                        <input type="color" name="color" id="color" value="<?php echo esc_attr($widget_config['color'] ?? '#007bff'); ?>" />
                        <p class="description"><?php _e('Color for the chat button', 'synaplan-wp-ai'); ?></p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description"><?php _e('Color for the icon inside the button', 'synaplan-wp-ai'); ?></p>
                    </td>
                </tr>
                    ...
                    <td>
                        <select name="position" id="position" class="regular-text">
                            ...
                            <option value="bottom-center" <?php selected($widget_config['position'] ?? 'bottom-right', 'bottom-center'); ?>>
                                <?php _e('Bottom Center', 'synaplan-wp-ai'); ?>
                            </option>
                        </select>
                        <p class="description"><?php _e('Position of the chat button on your site', 'synaplan-wp-ai'); ?></p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description"><?php _e('First message shown to visitors', 'synaplan-wp-ai'); ?></p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            ...
                            <?php _e('Automatically open chat widget after a few seconds', 'synaplan-wp-ai'); ?>
                        </label>
                    </td>
                </tr>
                    ...
                    <td>
                        <select name="prompt" id="prompt" class="regular-text">
                            <option value="general" <?php selected($widget_config['prompt'] ?? 'general', 'general'); ?>>
                                <?php _e('General Support', 'synaplan-wp-ai'); ?>
                            </option>
                            <option value="sales" <?php selected($widget_config['prompt'] ?? 'general', 'sales'); ?>>
                                <?php _e('Sales Assistant', 'synaplan-wp-ai'); ?>
                            </option>
                            <option value="technical" <?php selected($widget_config['prompt'] ?? 'general', 'technical'); ?>>
                                <?php _e('Technical Support', 'synaplan-wp-ai'); ?>
                            </option>
                            <option value="customer_service" <?php selected($widget_config['prompt'] ?? 'general', 'customer_service'); ?>>
                                <?php _e('Customer Service', 'synaplan-wp-ai'); ?>
                            </option>
                        </select>
                        <p class="description">
                            <?php _e('You can customize prompts further on the', 'synaplan-wp-ai'); ?>
                            <a href="https://app.synaplan.com/index.php/prompts" target="_blank"><?php _e('Synaplan Dashboard', 'synaplan-wp-ai'); ?></a>
                        </p>
                    </td>
                </tr>
            </table>
        ...
        <p class="submit">
            <input type="submit" name="submit" id="submit" class="button button-primary" value="<?php _e('Save Changes', 'synaplan-wp-ai'); ?>" />
        </p>
    </form>
    
    <div class="settings-info">
        <h3><?php _e('Advanced Configuration', 'synaplan-wp-ai'); ?></h3>
        <p>
            <?php _e('For advanced settings like managing your knowledge base, configuring AI prompts, and accessing analytics, visit the', 'synaplan-wp-ai'); ?>
            <a href="https://app.synaplan.com/" target="_blank"><?php _e('Synaplan Dashboard', 'synaplan-wp-ai'); ?></a>.
        </p>
    </div>
</div>
